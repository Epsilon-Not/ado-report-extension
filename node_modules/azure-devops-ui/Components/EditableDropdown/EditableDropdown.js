...
var EditableDropdown = /** @class */ (function (_super) {
    tslib_1.__extends(EditableDropdown, _super);
    ...
    EditableDropdown.prototype.render = function () {
        return (React.createElement(CustomEditableDropdown, tslib_1.__assign({}, this.props, { onTextChange: this.onTextChange, onValueChange: this.onValueChange, ref: this.dropdown, selectedText: this.selectedText, text: this.text })));
    };
