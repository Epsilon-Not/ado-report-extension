...
export interface IEditableDropdownProps<T = {}> extends Pick<IDropdownProps<T>, "ariaLabel" | "className" | "calloutContentClassName" | "disabled" | "filterByText" | "filterItem" | "filterThrottleWait" | "getUnselectableRanges" | "items" | "onCollapse" | "onExpand" | "placeholder" | "noItemsText" | "renderCallout" | "renderExpandable" | "renderItem" | "selection"> {
    /**
