    ...
    VssPersona.prototype.render = function () {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement(Tooltip, { text: displayName, showOnFocus: true },
                React.createElement("div", tslib_1.__assign({ className: css("vss-Persona flex-noshrink", this.props.className, this.props.cssClass, size), ref: this.setTargetElement }, additionalAttributes), imageElement)),
