...
var IdentityCardContent = /** @class */ (function (_super) {
    ...
    IdentityCardContent.prototype.render = function () {
        ...
        return (React.createElement(Callout, { onDismiss: this.onDismissCallout, anchorElement: targetElement, anchorOrigin: { horizontal: "end" /* end */, vertical: "start" /* start */ }, calloutOrigin: { horizontal: "start" /* start */, vertical: "start" /* start */ }, ariaLabel: Resources.IdentityCardProfileCardAriaLabel, className: "bolt-identity-card-callout h-scroll-hidden depth-8", contentClassName: "v-scroll-auto", lightDismiss: true, ref: this.props.calloutRef },
    ...
    IdentityCardContent.prototype.renderCard = function () {
        ...
        return innerCard ? (React.createElement(FocusZone, { circularNavigation: true, defaultActiveElement: ".bolt-identity-card-focus-element", direction: 2 /* Vertical */, focusOnMount: true, handleTabKey: true },
