...
export var MasterPanel = function (props) {
    ...
    return (React.createElement(Surface, { background: 1 /* neutral */ },
        React.createElement(Observer, { masterDetailsLayer: { observableValue: masterDetailsContext.getCurrentLayer() } }, function (observerProps) {
            return (React.createElement(MasterPanelInternal, { className: className, layer: observerProps.masterDetailsLayer, showOnSmallScreens: showOnSmallScreens }));
        })));
};
var MasterPanelInternal = function (props) {
    ...
    var masterDetailsContext = React.useState(MasterDetailsContext);
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { ref: tabStop, "aria-label": layer.ariaLabel, tabIndex: -1 }),
