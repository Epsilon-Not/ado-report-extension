...
export var Card = function (props) {
    ...
    return (React.createElement(CustomCard, { className: css(props.className, (text || headerCommandBarItems) && "bolt-card-with-header") }, collapsible ? (React.createElement(Observer, { collapsed: collapsed }, function (observerProps) { return (React.createElement(React.Fragment, null,
        (text || headerCommandBarItems || renderHeader) && (React.createElement("div", { className: "flex-row" },
            React.createElement(Button, { ariaLabel: observerProps.collapsed ? Resources.ExpandButtonAriaLabel : Resources.CollapseButtonAriaLabel, subtle: true, iconProps: { iconName: observerProps.collapsed ? "ChevronRight" : "ChevronDown" }, className: "bolt-card-expand-button flex-self-start", onClick: onCollapseClick }),
            renderHeader ? (renderHeader()) : (React.createElement(CardHeader, tslib_1.__assign({}, props, { headerClassName: css(props.headerClassName, "bolt-card-expandable-header", observerProps.collapsed && "bolt-card-header-collapsed") }))))),
        !observerProps.collapsed && React.createElement(CardContent, tslib_1.__assign({}, props.contentProps), props.children))); })) : (React.createElement(React.Fragment, null,
        renderHeader ? renderHeader() : (text || headerCommandBarItems) && React.createElement(CardHeader, tslib_1.__assign({}, props)),
        React.createElement(CardContent, tslib_1.__assign({}, props.contentProps), props.children)))));
};
