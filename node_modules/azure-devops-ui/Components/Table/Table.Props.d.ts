 ...
 */
export declare const enum ColumnJustification {
    Left = 0,
    Right = 1
}
/**
 ...
 */
export declare const enum IMeasurementStyle {
    /**
...
export interface ITableColumn<T> {
     ...
     */
    renderHeaderCell?: (columnIndex: number, tableColumn: ITableColumn<T>, focuszoneId: string | undefined, isFirstActionableHeader?: boolean) => JSX.Element;
    /**
