...
import { ITableColumn, TableColumnLayout, IMeasurementStyle } from "./Table.Props";
/**
...
export declare class ColumnMore<T> implements ITableColumn<T> {
     ...
     */
    constructor(menuProvider: (listItem: T) => IMenuProps, menuAvailable?: (listItem: T) => boolean, onActiviate?: (rowIndex: number, columnIndex: number) => void);
