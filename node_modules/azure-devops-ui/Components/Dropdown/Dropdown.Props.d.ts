...
export interface IDropdownProps<T = {}> extends IListBoxSharedProps<T>, Pick<IDropdownCalloutProps<T>, "actions" | "calloutContentClassName" | "filteredNoResultsText" | "filterPlaceholderText" | "noItemsText" | "showFilterBox" | "userFilteredItems" | "userFilteredItemsIndexMap">, Pick<IDropdownExpandableProps<T>, "ariaLabel" | "className" | "disabled" | "onCollapse" | "onExpand" | "placeholder"> {
    /**
