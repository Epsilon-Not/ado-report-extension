...
export function WithPivots(props) {
    var renderCallout = function (calloutProps) {
        return (React.createElement(DropdownCallout, tslib_1.__assign({}, calloutProps, props.calloutProps, { onFilterTextChanged: function (e, value) {
...
function renderPivots(props) {
    ...
    return (React.createElement(FocusZoneContext.Consumer, null, function (verticalContext) { return (React.createElement(FocusZone, { direction: 1 /* Horizontal */ },
