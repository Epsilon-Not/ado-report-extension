...
var Breadcrumb = /** @class */ (function (_super) {
    ...
    function Breadcrumb(props) {
        ...
        _this.renderItem = function (item) {
            var internalItem = (React.createElement(React.Fragment, null,
                item.iconProps && (React.createElement(Icon, tslib_1.__assign({}, item.iconProps, { className: css("bolt-breadcrumb-item-icon", !item.text && "icon-only", item.iconProps.className) }))),
    ...
    Breadcrumb.prototype.render = function () {
        ...
        var overflowMenuItems = items.map(function (item, index) {
            return (tslib_1.__assign({ data: item, iconProps: item.iconProps, text: item.text, id: item.key, href: item.href }, item.menuItemProps, { onActivate: _this.onMenuItemActivate }));
        });
