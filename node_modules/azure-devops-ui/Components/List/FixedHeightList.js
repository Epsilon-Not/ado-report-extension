...
var FixedHeightList = /** @class */ (function (_super) {
    tslib_1.__extends(FixedHeightList, _super);
    ...
    FixedHeightList.prototype.render = function () {
        ...
        list = (React.createElement(FocusZone, tslib_1.__assign({ direction: 2 /* Vertical */, skipHiddenCheck: true }, focuszoneProps), list));
