...
var ResponsiveLayout = /** @class */ (function (_super) {
    ...
    ResponsiveLayout.prototype.render = function () {
        ...
        var children = React.cloneElement(container, tslib_1.__assign({}, container.props, { ref: this.containerRef }), React.Children.map(container.props.children, function (child, index) {
            if ($DEBUG) {
