...
var CustomIdentityPickerDropdown = /** @class */ (function (_super) {
    ...
    function CustomIdentityPickerDropdown(props) {
        ...
        _this.renderSuggestionItem = function (suggestion) {
            return (React.createElement("div", { className: "flex-row flex-grow scroll-hidden", onKeyDown: _this.onKeyDownSuggestionItem },
                React.createElement(IdentityPickerSuggestionItem, tslib_1.__assign({}, suggestion, { onOpenPersonaCard: _this.openPersonaCard, ref: function (itemRef) { return (_this.itemRefs[suggestion.item.entityId] = itemRef); }, renderSuggestion: _this.props.renderCustomIdentitySuggestion && _this.renderCustomSuggestionItem }))));
        };
        ...
        _this.renderPersonaCoin = function (className) {
            return (React.createElement(Observer, { selectedIdentity: _this.props.value, isEditing: _this.isEditing }, function (props) {
                return props.selectedIdentity && !props.isEditing ? (React.createElement(Persona, { className: css("flex-row flex-center justify-center", className), identity: props.selectedIdentity, size: 24 /* size24 */ })) : (React.createElement(Icon, { className: css("flex-row flex-center justify-center", className), iconName: "Contact", size: "medium" /* medium */ }));
            }));
        };
        ...
        _this.onKeyDown = function (ev) {
            ...
            switch (keyCode) {
                ...
                case 13 /* enter */:
                    ...
                    else if (keyCode === 13 /* enter */ && input && !input.value) {
        ...
        _this.onKeyDownSuggestionItem = function (event) {
            if (!event.defaultPrevented) {
                if (event.which === 37 /* leftArrow */ || event.which === 27 /* escape */ || event.which === 9 /* tab */) {
                    if (_this.inputElement.current) {
                        _this.inputElement.current.focus();
    ...
    CustomIdentityPickerDropdown.prototype.render = function () {
        var _this = this;
        var _a = this.props, autoFocus = _a.autoFocus, disabled = _a.disabled, _b = _a.editPlaceholder, editPlaceholder = _b === void 0 ? Resources.IdentityPickerPlaceholderFocusText : _b, _c = _a.placeholder, placeholder = _c === void 0 ? Resources.IdentityPickerPlaceholderText : _c;
                ...
                return (React.createElement(React.Fragment, null,
                    React.createElement(Observer, { selectedIdentity: _this.props.value, selectedIndex: _this.selectedIndex, suggestionsLoading: _this.suggestionsLoading, textValue: _this.props.textValue }, function (props) {
                        ...
                        return (React.createElement(Measure, { onMeasure: _this.onTextFieldChanged },
                            React.createElement("div", { className: "bolt-identitypickerdropdown flex-row flex-grow", ref: _this.outerElement, onKeyDown: _this.onKeyDown, role: "combobox", "aria-expanded": topProps.suggestionsVisible },
                                React.createElement(TextField, { ariaActiveDescendant: ariaActiveDescendantId, ariaAutoComplete: "list", ariaControls: ariaControlsId, autoFocus: autoFocus, ariaHasPopup: "listbox", ariaLabel: props.textValue === "" ? placeholderText : props.textValue, className: css(_this.props.className, "bolt-identitypickerdropdown-textField flex-row flex-center", focusStatus.hasFocus && "bolt-identitypickerdropdown-open"), containerClassName: "bolt-identitypickerdropdown-container flex-column flex-grow", onBlur: focusStatus.onBlur, onChange: _this.onSearchChange, onClick: _this.onClick, onFocus: focusStatus.onFocus, prefixIconProps: { render: _this.renderPersonaCoin }, placeholder: placeholderText, ref: _this.inputElement, role: "textbox", suffixIconProps: props.textValue && !disabled
                                        ? {
                                            iconName: "Clear",
