...
var TypeAhead = /** @class */ (function (_super) {
    ...
    TypeAhead.prototype.render = function () {
        ...
        return (React.createElement(TextField, tslib_1.__assign({}, this.props, { className: css(className, "bolt-typeahead"), onKeyDown: this.onKeyDown, ref: this.textFieldRef, value: renderValue })));
    };
