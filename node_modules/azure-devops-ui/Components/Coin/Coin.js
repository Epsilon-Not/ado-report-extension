...
var Coin = /** @class */ (function (_super) {
    ...
    Coin.prototype.render = function () {
        var _a = this.props, className = _a.className, displayName = _a.displayName, dataIsFocusable = _a.dataIsFocusable, onClick = _a.onClick, isTabStop = _a.isTabStop, _b = _a.imgAltText, imgAltText = _b === void 0 ? "" : _b, imageUrl = _a.imageUrl, size = _a.size, tooltipProps = _a.tooltipProps;
        ...
        var content = (React.createElement("div", tslib_1.__assign({ className: css("bolt-coin flex-noshrink", className, sizeClass, onClick && "cursor-pointer") }, additionalAttributes), imageElement));
        if (tooltipProps !== null) {
            return (React.createElement(Tooltip, tslib_1.__assign({ text: displayName, showOnFocus: true }, tooltipProps), content));
        }
        else {
            return content;
        }
