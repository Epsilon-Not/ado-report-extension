...
var CalloutContent = /** @class */ (function (_super) {
    ...
    CalloutContent.prototype.render = function () {
        ...
        if (blurDismiss && focuszoneProps) {
            content = (React.createElement(FocusWithin, { onBlur: this.onBlur, updateStateOnFocusChange: false }, function (props) { return React.createElement(FocusZone, tslib_1.__assign({}, focuszoneProps), _this.renderContent(props.onFocus, props.onBlur)); }));
        }
        else {
            ...
            if (focuszoneProps) {
                content = React.createElement(FocusZone, tslib_1.__assign({}, focuszoneProps), content);
            }
        }
    ...
    CalloutContent.prototype.renderContent = function (onFocus, onBlur) {
        ...
        return (React.createElement("div", { "aria-describedby": getSafeId(this.props.ariaDescribedBy), "aria-label": this.props.ariaLabel, "aria-labelledby": getSafeId(this.props.ariaLabelledBy), "aria-modal": this.props.modal, className: css(this.props.contentClassName, "bolt-callout-content", this.props.contentShadow && "bolt-callout-shadow", contentJustification === 3 /* Stretch */ && "flex-grow", contentOrientation === 0 /* Column */ && "flex-column", contentOrientation === 1 /* Row */ && "flex-row", contentSize === 0 /* Small */ && "bolt-callout-small", contentSize === 1 /* Medium */ && "bolt-callout-medium", contentSize === 2 /* Large */ && "bolt-callout-large", contentSize === 3 /* Auto */ && "bolt-callout-auto"), onBlur: onBlur, onFocus: onFocus, onScroll: this.onScroll, ref: this.contentElement, role: this.props.role || "dialog" }, this.props.children));
    };
