...
var Panel = /** @class */ (function (_super) {
    ...
    Panel.prototype.render = function () {
        ...
        return (React.createElement(CustomPanel, tslib_1.__assign({ ariaLabelledBy: titleId }, props, { id: id, lightDismiss: overlayContent ? false : props.lightDismiss, ref: this.customPanelRef }),
            React.createElement(PanelHeader, { backButtonProps: backButtonProps, description: description, onDismiss: onDismiss, showSeparator: showSeparator, titleProps: tslib_1.__assign({ id: titleId }, titleProps) }),
