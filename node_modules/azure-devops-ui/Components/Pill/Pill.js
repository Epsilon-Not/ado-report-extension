...
var Pill = /** @class */ (function (_super) {
    ...
    Pill.prototype.render = function () {
        ...
        return (React.createElement(FocusZoneContext.Consumer, null, function (zoneContext) { return (React.createElement("div", { "aria-hidden": ariaHidden, className: css(className, "bolt-pill flex-row flex-center", Pill.getVariantClass(variant, color), Pill.getSizeClass(size), containsCount && "count", isHoveringPrimaryElement && "hover", onClick && "clickable", onRenderFilledVisual && "has-filled-visual", iconProps && !onRenderFilledVisual && "has-icon", onRemoveClick && "has-remove-button"), "data-focuszone": !_this.props.excludeFocusZone ? zoneContext.focuszoneId : undefined, id: getSafeId(id), onClick: onClick, onKeyDown: _this.onKeyDown, onMouseEnter: _this.onMouseEnter, onMouseLeave: _this.onMouseLeave, role: onClick ? "button" : "presentation", style: Pill.getColorStyle(color, isHoveringPrimaryElement, onClick), tabIndex: getTabIndex(_this.props) },
            ...
            onRemoveClick && (React.createElement(Button, { ariaLabel: Resources.RemovePillLabel, className: "bolt-pill-button", iconProps: { iconName: "Cancel", size: "" /* inherit */ }, onClick: onRemoveClick, onMouseLeave: _this.onMouseLeaveButton, onMouseOver: _this.onMouseOverButton, subtle: true, tooltipProps: { text: Resources.RemovePillLabel } })))); }));
    };
    return Pill;
}(React.Component));
export { Pill };
