...
export function HeaderTitle(props) {
    ...
    return (React.createElement("div", { "aria-level": ariaLevel, className: css(props.className, "bolt-header-title", titleSizeClass), id: getSafeId(id), role: "heading" }, props.children));
}
