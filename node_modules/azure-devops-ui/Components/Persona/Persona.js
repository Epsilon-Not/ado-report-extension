...
var Persona = /** @class */ (function (_super) {
    ...
    Persona.prototype.render = function () {
        var _a = this.props, ariaHidden = _a.ariaHidden, className = _a.className, personaProvider = _a.personaProvider, identity = _a.identity, size = _a.size, tooltipProps = _a.tooltipProps;
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement("div", { "aria-hidden": ariaHidden, ref: this.targetElement },
                React.createElement(Coin, { className: className, dataIsFocusable: canShowPersonaCard, isTabStop: canShowPersonaCard, onClick: canShowPersonaCard ? this.onClick : undefined, displayName: identity.displayName || "", imageUrl: this.getServerImageFromSize(image), imgAltText: identity.displayName, size: size, tooltipProps: tooltipProps })),
    ...
    Persona.prototype.getServerImageFromSize = function (url) {
        ...
        if (this.props.size) {
            if (this.props.size <= 24 /* size24 */) {
                return url + (url.indexOf("?") === -1 ? "?size=0" : "&size=0");
            }
            else if (this.props.size > 40 /* size40 */) {
