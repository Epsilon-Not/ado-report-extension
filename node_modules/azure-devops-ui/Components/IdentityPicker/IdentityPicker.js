...
var IdentityPicker = /** @class */ (function (_super) {
    ...
    function IdentityPicker(props) {
        ...
        _this.emailRegex = RegExp("^[a-z0-9!#$%&'*+/=?^_`{|}~-]+(?:.[a-z0-9!#$%&'*+/=?^_`{|}~-]+)*@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])?$", "i");
        ...
        _this.renderSuggestionItem = function (suggestion) {
            return (React.createElement("div", { className: "flex-row flex-grow", onKeyDown: _this.onKeyDownSuggestionItem },
                React.createElement(IdentityPickerSuggestionItem, tslib_1.__assign({}, suggestion, { onOpenPersonaCard: _this.onOpenPersonaCard, ref: function (itemRef) { return (_this.itemRefs[suggestion.item.entityId] = itemRef); }, renderSuggestion: _this.props.renderCustomIdentitySuggestion && _this.renderCustomSuggestionItem }))));
        };
        ...
        _this.onDelimitedSearch = function (emailList) {
            var emails = emailList
                ...
                return _this.emailRegex.test(email) &&
                    !ObservableLike.getValue(_this.props.selectedIdentities).some(function (selectedIdentity) { return selectedIdentity.entityId === email; });
            });
        ...
        _this.convertItemToPill = function (person, index) {
            ...
            return !!_this.props.convertItemToPill && person.entityType === "custom" /* Custom */
                ...
                : {
                    ...
                    onRenderFilledVisual: isUnresolvedEmail
                        ? undefined
                        : function () {
                            return React.createElement(Persona, { className: "flex-row flex-center", identity: person, size: 20 /* size20 */ });
                        }
                };
        };
        ...
        return (React.createElement("div", { className: this.props.className, ref: this.outerElement },
            React.createElement(Observer, { openedIdentityCard: this.openedIdentityCard }, function (props) {
                return (React.createElement(React.Fragment, null,
                    React.createElement(TagPicker, { suggestionsLoading: _this.suggestionsLoading, areTagsEqual: _this.areTagsEqual, convertItemToPill: _this.convertItemToPill, deliminator: _this.props.onResolveEmail && ";", noResultsFoundText: Resources.IdentityPickerNoResultsText, onBlur: _this.props.onBlur, onDelimitedSearch: _this.props.onResolveEmail && _this.onDelimitedSearch, onEmptyInputFocus: _this.onEmptyInputFocus, onSearchChanged: _this.onResolveSuggestions, onSuggestionExpanded: _this.focusContactCardButton, onTagAdded: _this.onAddIdentity, onTagRemoved: _this.props.onIdentityRemoved, onTagsRemoved: _this.props.onIdentitiesRemoved, placeholderText: _this.props.placeholderText || Resources.MultiIdentityPickerPlaceholderText, prefixIconProps: {
    ...
    IdentityPicker.prototype.updateResolvedEmail = function (suggestions, email) {
        ...
        if (Array.isArray(suggestionsArray)) {
            this.props.onResolveEmail &&
                suggestionsArray.length === 1 &&
                this.props.onResolveEmail(email, !ObservableLike.getValue(this.props.selectedIdentities).some(function (identity) { return identity.entityId === suggestionsArray[0].entityId; })
                    ? suggestionsArray[0]
                    : null);
        }
            ...
            promise.promise.then(function (newSuggestions) {
                _this.props.onResolveEmail &&
                    newSuggestions.length === 1 &&
                    _this.props.onResolveEmail(email, !ObservableLike.getValue(_this.props.selectedIdentities).some(function (identity) { return identity.entityId === newSuggestions[0].entityId; })
                        ? newSuggestions[0]
                        : null);
            });
        }
