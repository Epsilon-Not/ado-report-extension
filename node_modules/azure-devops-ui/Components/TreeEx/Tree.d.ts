...
export declare function renderTreeRow<T>(rowIndex: number, item: ITreeItemEx<T>, details: ITreeRowDetails<T>, columns: ITreeColumn<T>[], data?: T, className?: string): JSX.Element;
/**
