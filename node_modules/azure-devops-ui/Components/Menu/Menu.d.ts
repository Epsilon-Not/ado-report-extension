...
export declare class Menu extends React.Component<IMenuProps, IMenuState> implements IMenu {
    ...
    render(): JSX.Element;
    expandItem: (menuItem: IMenuItem, expanded: boolean) => void;
    focus: () => void;
    getParent: () => IMenu;
    onActivate: (menuItem: IMenuItem, event?: React.KeyboardEvent<HTMLElement> | React.MouseEvent<HTMLElement, MouseEvent>) => void;
    private renderList;
