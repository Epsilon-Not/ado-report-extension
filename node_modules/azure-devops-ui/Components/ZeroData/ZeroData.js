...
var ZeroDataItem = /** @class */ (function (_super) {
    ...
    ZeroDataItem.prototype.renderAction = function (item) {
        ...
        if (item.actionType === 0 /* ctaButton */ || item.actionType === 1) {
            ...
            var buttonProps = {
                ...
                role: item.actionHref ? "link" : undefined
            };
            return React.createElement(Button, tslib_1.__assign({}, buttonProps, { primary: true }));
        }
        else {
