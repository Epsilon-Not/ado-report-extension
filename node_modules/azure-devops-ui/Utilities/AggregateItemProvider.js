...
var AggregateItemProvider = /** @class */ (function (_super) {
    tslib_1.__extends(AggregateItemProvider, _super);
    ...
    AggregateItemProvider.prototype.subscribe = function (observer, action) {
        ...
        if (this.subscriberCount === 1) {
            ...
            (_a = this.items).splice.apply(_a, [0, this.items.length].concat(currentItems));
        }
    };
    ...
    AggregateItemProvider.prototype.getSubscriber = function (collectionIndex) {
        ...
        return function (args) {
            ...
            if (args.changedItems) {
                // Handle change event
                (_a = _this.items).splice.apply(_a, [index, args.changedItems.length].concat(args.changedItems));
