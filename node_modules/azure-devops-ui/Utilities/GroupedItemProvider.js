...
var GroupedItemProvider = /** @class */ (function () {
    ...
    GroupedItemProvider.prototype.change = function (start) {
        ...
        (_a = this.listItems).change.apply(_a, [start].concat(items));
        return items.length;
    };
    /**
        ...
        for (var i = 0; i < deleteCount; i++) {
            ...
            if (this.groupedItems.length > groupIndex) {
                ...
                if (this.manageHeaders) {
                    ...
                    if (firstGroupWithItemsIndex > 0 && this.groupedItems[firstGroupWithItemsIndex][0].type === 3 /* Divider */) {
    ...
    GroupedItemProvider.prototype.setGroupLoading = function (groupId, loading, loadingItem) {
        ...
        var loadingItemIndex = groupItems.findIndex(function (item) { return item.type === 4 /* Loading */; });
        if (!loading && groupItems.length && loadingItemIndex > -1) {
            ...
            var newItem = loadingItem || { id: groupId + "-loading", type: 4 /* Loading */, groupId: groupId };
    ...
    GroupedItemProvider.prototype.addHeaders = function (start, count) {
        ...
        var _loop_1 = function (i) {
            ...
            if (this_1.groupedItems[i].length > 0) {
                if (!this_1.groupedItems[i].find(function (item) { return item.type === 2 /* Header */; })) {
                    this_1.addItems([{ id: group.id + "-header", text: group.name || group.id, type: 2 /* Header */, groupId: group.id }]);
                }
                ...
                if (this_1.groupedItems.some(function (items, index) { return index < i && items.length > 0; }) &&
                    !this_1.groupedItems[i].find(function (item) { return item.type === 3 /* Divider */; })) {
                    this_1.addItems([{ id: group.id + "-divider", type: 3 /* Divider */, groupId: group.id }]);
                }
                ...
                if (nextGroupWithItemsIndex > 0 && !this_1.groupedItems[nextGroupWithItemsIndex].find(function (item) { return item.type === 3 /* Divider */; })) {
    ...
    GroupedItemProvider.prototype.addToListItems = function () {
        ...
        for (var i = keys.length - 1; i >= 0; i--) {
            (_a = this.listItems).splice.apply(_a, [parseInt(keys[i]), 0].concat(indexToItemMapping[parseInt(keys[i])]));
        }
    };
    GroupedItemProvider.prototype.addItem = function (item, index) {
        ...
        if (item.type === 3 /* Divider */) {
            ...
            if (this.groupedItems[groupIndex].length && this.groupedItems[groupIndex][0].type === 3 /* Divider */) {
