...
export interface IObservable<T, TAction extends string = string> {
     ...
     */
    subscribe: (observer: (value: T, action?: TAction) => void, action?: TAction) => void;
    /**
...
export declare class Observable<T, TAction extends string = string> implements IObservable<T, TAction> {
    ...
    subscribe(observer: (value: T, action: TAction) => void, action?: string): void;
...
export declare namespace ObservableLike {
     ...
     */
    function isObservable<T>(observableLike: IObservable<T> | any): boolean;
    /**
     ...
     *  while all actions are delivered is no action is supplied.
     */
    function subscribe<T>(observableLike: IObservable<T> | any, observer: (value: T, action: string) => void, action?: string): void;
    /**
...
export declare class ObservableCollection<T> extends Observable<IObservableArrayEventArgs<T>, ObservableArrayAction> implements IReadonlyObservableArray<T> {
    ...
    subscribe(observer: (value: IObservableArrayEventArgs<T>, action: ObservableArrayAction) => void, action?: ObservableArrayAction): void;
